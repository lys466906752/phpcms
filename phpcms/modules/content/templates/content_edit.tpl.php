...
<div class="tab-pane fade in" id="pics">
			...
			?>
				<div>
					...
					<div>[<a href="javascript:void(0);" class="add">+</a>]商品图片：<input type="file" name="pics[]" value="" class="input-xlarge"><?php echo $pic['pic']?></div>
				 <?php 
				}
				?>
                    ...
                    <div class="well">
                            <div>[<a href="javascript:void(0);" class="add">+</a>]商品图片：<input type="file" name="pics[]" value="" class="input-xlarge"></div>
                    </div>
                </div>
                </div>
        	</div>
...
$(function(){
	...
	$('.add').click(function(){
                var add_div = '<div>[<a href="javascript:void(0);" class="sub">-</a>]商品图片：<input type="file" name="pics[]" value="" class="input-xlarge"></div>';
