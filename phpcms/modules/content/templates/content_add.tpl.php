...
?>
<td>上传图片在哪里<input type="text" name="status" value="1" >
/td>
<div class="tab-pane fade in" id="pics">
                    <div class="well">

                        <div>[<a href="javascript:void(0);" class="add">+</a>]商品图片：<input type="file" name="pics[]" value="" class="input-xlarge">alt:<input type="text" name="alt[]"></div>
                    </div>
                </div>
    </tbody></table>
                </div>
...
$(function(){
	 ...
	 $('.add').click(function(){
                var add_div = '<div>[<a href="javascript:void(0);" class="sub">-</a>]商品图片：<input type="file" name="goods_pics[]" value="" class="input-xlarge">alt:<input type="text" name="alt[]"></div>';
