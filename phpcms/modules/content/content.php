...
class content extends admin {
	...
	public function add() {
		...
		if(isset($_POST['dosubmit']) || isset($_POST['dosubmit_continue'])) {
			...
			print_r($data);
			$res = $this->newspic_db->insert($data);
	...
	public function edit() {
			...
			$where = 'catid ='.$catid;
			$pics = $this->newspic_db->select($where, 'pic');
			// print_r($pics);die;
...
//     $info = $_FILES;
	...
	function uploadfile($path="uploads",
		...
		$path="uploads/".date('Y',time()).'/'.date('md',time()).'/';
